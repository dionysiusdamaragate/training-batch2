 ...
 * CedCommerce
  ...
  */ 
namespace Ced\Advancedmatrix\Block\Adminhtml\Carrier\Advancedrate;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Ced\Advancedmatrix\Model\ResourceModel\Carrier\Advancedrate\CollectionFactory $collectionFactory,
        \Ced\Advancedmatrix\Model\Carrier\Advancedrate $tablerate,
        array $data = []
    ) {
    ...
    {
        /** @var $collection \Ced\Advancedmatrix\Model\Resource\Carrier\Advancedrate\Collection */
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn(
            ...
            ['header' => __('City'), 
              'index' => 'city', 
              'default' => '*',
              'renderer' => 'Ced\Advancedmatrix\Block\Adminhtml\Carrier\Advancedrate\Renderer\City'
            ]
        );		
        $this->addColumn(
            'dest_zip',
