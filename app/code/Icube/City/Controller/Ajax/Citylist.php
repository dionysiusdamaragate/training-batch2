            ...
            if ($region) {
                ...
                foreach ($statearray as $city) {
					...
					if($selectedCity == $citycurrent) {
						$cityList .= "<option selected value='".$city['city']."/".$city['kecamatan']."'>".$city['city']." - ".$city['kecamatan']."</option>";
					} else {
						$cityList .= "<option value='".$city['city']."/".$city['kecamatan']."'>".$city['city']." - ".$city['kecamatan']."</option>";
					}
